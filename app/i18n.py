...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "pd_u21_until": {"en": "U21-eligible until", "bg": "Може за U21 до"},
    ...
    "pd_claim_title": {"en": "Scout claim", "bg": "Скаутско поемане"},
    "pd_claim_btn": {"en": "I'll handle this player (as scout)", "bg": "Аз ще водя този играч (като скаут)"},
    ...
    "me_staff": {"en": "Specialists", "bg": "Специалисти"},
    "staff_type_1": {"en": "Assistant coach", "bg": "Помощник-треньор"},
    "staff_type_2": {"en": "Medic", "bg": "Лекар"},
    "staff_type_3": {"en": "Spokesperson", "bg": "Говорител"},
    "staff_type_4": {"en": "Sport psychologist", "bg": "Спортен психолог"},
    "staff_type_5": {"en": "Form coach", "bg": "Треньор по форма"},
    "staff_type_6": {"en": "Financial director", "bg": "Финансов директор"},
    "staff_type_7": {"en": "Tactical assistant", "bg": "Тактически асистент"},
